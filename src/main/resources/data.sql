INSERT INTO VIDEOGAME_GENRE(ID, NAME) VALUES (1, 'RPG');
INSERT INTO VIDEOGAME_GENRE(ID, NAME) VALUES (2, 'Shmup');

INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (1, 'Aether Chronicles: Rise of the Phoenix', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (2, 'Nebulas Descent: Awakening', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (3, 'Whispers of the Void: Echoes', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (4, 'Titans of the Ancients: Reawakened', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (5, 'Temporal Quest: Nexus of Destiny', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (6, 'Mist of the Forgotten: Haunting Shadows', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (7, 'Abyssal Depths: Leviathans Call', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (8, 'Warriors of Fate: Twilight Vanguard', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (9, 'Pandemic Zone: Survivors Escape', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (10, 'Explorers Saga: Hidden Realms', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (12, 'Infernos Ascent: Rekindled Fury', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (13, 'Galactic Marines: Stellar Conflict', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (14, 'Destinys Edge: Chronicles of Fate', 1);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (16, 'Nether Realms: Siege of Shadows', 2);
INSERT INTO VIDEOGAME (ID, TITLE, GENRE_ID) VALUES (17, 'Mythic Realms: Ascension', 1);


INSERT INTO VIDEOGAME_SAGA(ID, TITLE) VALUES (1, 'Final Chronicles');
INSERT INTO VIDEOGAME (ID, TITLE, SAGA_ID, RELEVANCE, GENRE_ID) VALUES (11, 'Relic Hunter: Curse of the Emerald Eye', 1, 1, 1);
INSERT INTO VIDEOGAME (ID, TITLE, SAGA_ID, RELEVANCE, GENRE_ID) VALUES (15, 'Cosmic Empires: Twilight of the Overlords', 1, 2, 2);
INSERT INTO VIDEOGAME (ID, TITLE, SAGA_ID, RELEVANCE, GENRE_ID) VALUES (19, 'Arcane Realms Online: Siege of the Sorcerer', 1, 3, 1);

INSERT INTO VIDEOGAME_SAGA(ID, TITLE) VALUES (2, 'Legend of Mist');
INSERT INTO VIDEOGAME (ID, TITLE, SAGA_ID, RELEVANCE, GENRE_ID) VALUES (18, 'Eternal Battlefront: Rise of the Phoenix', 2, 1, 2);
INSERT INTO VIDEOGAME (ID, TITLE, SAGA_ID, RELEVANCE, GENRE_ID) VALUES (20, 'Wasteland Chronicles: Edge of Survival', 2, 1, 1);

INSERT INTO VIDEOGAME_SAGA(ID, TITLE) VALUES (3, 'Shadowbane Chronicles');
INSERT INTO VIDEOGAME_SAGA(ID, TITLE) VALUES (4, 'Vanguard Destiny');
INSERT INTO VIDEOGAME_SAGA(ID, TITLE) VALUES (5, 'Eternal Legend: The Chronicles of Aeon');
INSERT INTO VIDEOGAME_SAGA(ID, TITLE) VALUES (6, 'Warlords of Valor: Rise of the Ancients');

INSERT INTO SAGA_RELATIONSHIP(SAGA_ID_1, SAGA_ID_2) VALUES(1, 2);
INSERT INTO SAGA_RELATIONSHIP(SAGA_ID_1, SAGA_ID_2) VALUES(1, 3);
INSERT INTO SAGA_RELATIONSHIP(SAGA_ID_1, SAGA_ID_2) VALUES(1, 5);
